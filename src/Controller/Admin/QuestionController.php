...
{
    /**
     * @Route("/", name="question_index", defaults={"page": "1"}, methods={"GET"})
     * @Route("/page/{page<[1-9]\d*>}", methods={"GET"}, name="question_index_paginated")
     */
    public function index(int $page, QuestionRepository $questionRepository): Response
    {
        return $this->render('admin/question/index.html.twig', [
            'questions' => $questionRepository->selectAll($page),
        ]);
    }
